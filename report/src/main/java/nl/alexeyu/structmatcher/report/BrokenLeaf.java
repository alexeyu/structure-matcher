 ...
 * filters) get both <em>where</em> a comparison broke and <em>why</em>, without re-walking the
 * tree.
 *
 * @param path
...
public record BrokenLeaf(String path, ExpectationBroken feedback) {
    ...
    /**
     * The expectation that was not met (e.g. the expected value, or a spec like
     * {@code "Non-null"}).
     */
