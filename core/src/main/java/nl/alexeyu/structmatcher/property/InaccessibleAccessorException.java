 ...
 * the accessor, or register a custom matcher for the property holding it: a matcher claiming an
 * enclosing path stops the recursion before this property is read.
 */
