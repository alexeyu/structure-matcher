 ...
 * empty) and matches those the way any other value is matched — simple values by equality, complex
 * values structurally. Two empty optionals match; a present one and an empty one do not. A
