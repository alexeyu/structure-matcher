 ...
 * properties between two concrete path elements would match.
 * <p>
 * Examples:
 * <table>
 * <th>Path</th><th>Property stack</th><th>Result</th>
 * <tr><td>A,B,C</td><td>A,B,C</td><td>Match</td></tr>
 * <tr><td>A,*</td><td>A,B,C</td><td>Match</td></tr>
 * <tr><td>A,*,C</td><td>A,B,C</td><td>Match</td></tr>
 * <tr><td>*,C</td><td>A,B,C</td><td>Match</td></tr>
 * <tr><td>*,B</td><td>A,B,C</td><td>Do not match - property stack is longer</td></tr>
 * <tr><td>A,B,C</td><td>A,B</td><td>Do not match - there is one more expectation in the path.</td></tr>
 * </table>
 */
