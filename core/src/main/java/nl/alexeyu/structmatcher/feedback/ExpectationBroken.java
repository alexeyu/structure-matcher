 ...
 * @param expectation
 *            description of an expected value. Depends on the implementation of
 *            a matcher. For example 'Non-null', 'A positive integer', '42'.
 * @param value
 *            actual value which does not match the provided expectation.
 */
public record ExpectationBroken(String property, Object expectation, Object value) implements FeedbackNode {
