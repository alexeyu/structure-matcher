...
public class ArrayMatcherTest {
    ...
    public void differentObjectArraysReportTheDifferingElement() {
        ...
        assertEquals(Feedback.composite("arr", asList(Feedback.nonEqual("arr[1]", "b", "c"))),
                feedback);
    }
    ...
    public void differentPrimitiveIntArraysReportTheDifferingElement() {
        ...
        assertEquals(Feedback.composite("arr", asList(Feedback.nonEqual("arr[2]", 3, 4))),
                feedback);
    }
    ...
    public void arraysOfComplexElementsAreMatchedStructurally() {
        ...
        var expectedFeedback = Feedback.composite("arr", asList(
                Feedback.composite("arr[0]", asList(Feedback.nonEqual("Bool", true, false)))));
    ...
    public void arrayPropertyIsMatchedEndToEndThroughObjectMatcher() {
        ...
        var expectedFeedback = Feedback.composite(ArrayHolder.class.getName(),
                asList(Feedback.composite("Tags", asList(Feedback.nonEqual("Tags[1]", "b", "c")))));
        assertEquals(expectedFeedback, feedback);
    }
}
