...
public class ContextAwareMatcherTest {
    ...
    public void callsDefaultMatcherIfCustomOneIsNotRegistered() {
        ...
        contextAwareMatcher = new ContextAwareMatcher(new SimpleProperty("test"), context,
    ...
    public void callsCustomMatcherIfRegistered() {
        MatchingStack<Object> context = new DefaultMatchingStack<>(null, null, Collections
                .singletonMap(new PropertyPathPattern(Arrays.asList("specific")), customMatcher));
        contextAwareMatcher = new ContextAwareMatcher(new SimpleProperty("specific"), context,
                defaultMatcherSupplier);
        var expectedFeedback = Feedback.empty("test");
    ...
    public void callsCustomIndirectMatcherIfRegistered() {
        ...
        MatchingStack<Object> context = new DefaultMatchingStack<>(expected, actual, Collections
                .singletonMap(new PropertyPathPattern(Arrays.asList("indirect")),
                        Matchers.asObjectMatcher(colorMatcher)));
        contextAwareMatcher = new ContextAwareMatcher(new SimpleProperty("indirect"), context,
                defaultMatcherSupplier);
