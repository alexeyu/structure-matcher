...
/**
 * Mirrors {@link StructureMatcherTest} but with {@code record} models. The resulting feedback is
 * identical, proving record components are matched exactly like the equivalent bean getters
 * (including the capitalized property names).
 */
public class RecordMatcherTest {
    ...
    public void allMatch() {
        var actual = new RecordStructure(Color.WHITE, asList("white color"),
                new RecordSubstructure(false));
        var expected = new RecordStructure(Color.WHITE, asList("white color"),
                new RecordSubstructure(false));
    ...
    public void allDontMatch() {
        var expected = new RecordStructure(Color.WHITE, asList("white color"),
                new RecordSubstructure(true));
        var actual = new RecordStructure(Color.BLACK, asList("black color"),
                new RecordSubstructure(false));
        ...
        var expectedFeedback = Feedback.composite("struct",
                asList(Feedback.nonEqual("Color", Color.WHITE, Color.BLACK), expColorListFeedback,
    ...
    public void customMatcherAppliesToNestedRecordComponentByPath() {
        ...
        var feedback = ObjectMatcher.forClass(RecordStructure.class)
                .with(Matchers.anyValue(), "Sub.Bool").match(expected, actual);
